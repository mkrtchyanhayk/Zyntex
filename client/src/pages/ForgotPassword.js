  ...
  return (
    <div className="max-w-md mx-auto gradient-border hover-lift anim-section">
      <div className="gradient-inner rounded-[1.45rem] p-6 card-rise">
        ...
        <p className="text-white/70 text-sm mb-6">Enter your email or username to receive a reset code</p>
      
      {step === 1 && (
        <form onSubmit={request} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1 text-white/90">Email or Username</label>
            <input 
      ...
      {step === 2 && (
        <form onSubmit={reset} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-1 text-white/90">6-Digit Code</label>
            <input 
              className="w-full input-focus text-white placeholder-white/40 text-center text-2xl tracking-widest" 
              placeholder="000000" 
              value={code} 
          ...
          <div>
            <label className="block text-sm font-medium mb-1 text-white/90">New Password</label>
            <input 
              className="w-full input-focus text-white placeholder-white/40" 
              type="password" 
